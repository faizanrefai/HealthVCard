...
-(IBAction)save{
	...
	[txtHealthno resignFirstResponder];
	[txtPostalCode resignFirstResponder];
	[txtProvince resignFirstResponder];
	[txtSin resignFirstResponder];
	[scrl resignFirstResponder];
...
-(void)JSON{
	...
	NSString *txtHelthcardno1=(NSString *) CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (CFStringRef)txtHealthno.text, NULL, CFSTR(":/?#[]@!$&’()*+,;="), kCFStringEncodingUTF8);
	...
	NSString *url=[NSString stringWithFormat:@"%@createAccount.php?name=%@&address=%@&city=%@&province=%@&postal_code=%@&DOB=%@&SIN=%@&health_card=%@&additional_info=%@&userid=%@",
				  appdel.strUrl,txtName1,txtAdd1,txtCity1,txtProvince1,txtPostalCode1,txtDob1,txtSin1,txtHelthcardno1,txtAdiinfo1,appdel.appUserId];
