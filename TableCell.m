...
-(void)JSONSave{
	...
	NSString *url=[NSString stringWithFormat:@"%@update_medical_note.php?nid=%@&title=%@&note=%@",appdel.strUrl,appdel.appNid,strtitle,strnote];
...
-(void)JSONDel{
	...
	NSString *url=[NSString stringWithFormat:@"%@delete_medical_note.php?nid=%@",appdel.strUrl,appdel.appNid];
	NSMutableURLRequest *request=[NSMutableURLRequest requestWithURL:[NSURL URLWithString:url]];
	JSONParser *parser;
