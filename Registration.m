...
-(void)JSON{
	...
	NSString *url=[NSString stringWithFormat:@"%@registration.php?LoginID=%@&Password=%@&FirstName=%@&LastName=%@&Email=%@",objappdel.strUrl,txtUserName.text,txtPwd.text,txtFirstNm.text,txtLastNm.text,txtEmail.text];
